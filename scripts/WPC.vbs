...
Private Sub LoadCore
	...
	If VPBuildVersion < 0 Or Err Then
		...
		ExecuteGlobal fso.OpenTextFile("VPMKeys.vbs", 1).ReadAll : If Err Then MsgBox "Can't open ""VPMKeys.vbs"":" & Err.Number: Exit Sub
	Else
		ExecuteGlobal GetTextFile("core.vbs")    : If Err Then MsgBox "Can't open ""core.vbs"""    : Exit Sub
		ExecuteGlobal GetTextFile("VPMKeysCustom.vbs") : If Err and Err.Number > 0 Then MsgBox "Error loading your custom ""VPMKeysCustom.vbs"":" & Err.Number
		ExecuteGlobal GetTextFile("VPMKeys.vbs") : If Err Then MsgBox "Can't open ""VPMKeys.vbs"":" & Err.Number: Exit Sub
	End If
End Sub
